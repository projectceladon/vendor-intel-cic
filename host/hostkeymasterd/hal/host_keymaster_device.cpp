...
HostKeymasterDevice::HostKeymasterDevice(const hw_module_t* module, HostKeymasterClient* hkm_client)
	:hkm_client_(hkm_client) {
    static_assert(std::is_standard_layout<HostKeymasterDevice>::value,
                  "HostKeymasterDevice must be standard layout");
    static_assert(offsetof(HostKeymasterDevice, device_) == 0,
                  "device_ must be the first member of HostKeymasterDevice");
    static_assert(offsetof(HostKeymasterDevice, device_.common) == 0,
	...
	// Connect to hostkeymaster
    hkm_client_->Open();
    if (!hkm_client_->IsOpen()) {
        ALOGE("Failed to connect hostkeymader service");
    }

    GetVersionRequest version_request;
    GetVersionResponse version_response;
    error_ = hkm_client_->host_keymaster_send(KM_GET_VERSION, version_request, &version_response);
    if (error_ == KM_ERROR_INVALID_ARGUMENT || error_ == KM_ERROR_UNIMPLEMENTED) {
        ALOGD("\"Bad parameters\" error on GetVersion call.  Version 0 is not supported.");
...
HostKeymasterDevice::~HostKeymasterDevice() {
    hkm_client_->Close();
}
...
keymaster_error_t HostKeymasterDevice::configure(const keymaster_key_param_set_t* params) {
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_CONFIGURE, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::add_rng_entropy(const uint8_t* data, size_t data_length) {
    ...
    return hkm_client_->host_keymaster_send(KM_ADD_RNG_ENTROPY, request, &response);
}

keymaster_error_t HostKeymasterDevice::generate_key(
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_GENERATE_KEY, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::get_key_characteristics(
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_GET_KEY_CHARACTERISTICS, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::import_key(
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_IMPORT_KEY, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::export_key(keymaster_key_format_t export_format,
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_EXPORT_KEY, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::attest_key(const keymaster_key_blob_t* key_to_attest,
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_ATTEST_KEY, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::upgrade_key(
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_UPGRADE_KEY, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::begin(keymaster_purpose_t purpose,
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_BEGIN_OPERATION, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::update(keymaster_operation_handle_t operation_handle,
                                                const keymaster_key_param_set_t* in_params,
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_UPDATE_OPERATION, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::finish(keymaster_operation_handle_t operation_handle,
                                                const keymaster_key_param_set_t* in_params,
                                                const keymaster_blob_t* input,
    ...
    keymaster_error_t err = hkm_client_->host_keymaster_send(KM_FINISH_OPERATION, request, &response);
    if (err != KM_ERROR_OK) {
        return err;
    }
...
keymaster_error_t HostKeymasterDevice::abort(keymaster_operation_handle_t operation_handle) {
    ...
    return hkm_client_->host_keymaster_send(KM_ABORT_OPERATION, request, &response);
}

keymaster_error_t HostKeymasterDevice::delete_key(const keymaster_key_blob_t* key) {
    ...
    return hkm_client_->host_keymaster_send(KM_DELETE_KEY, request, &response);
}

keymaster_error_t HostKeymasterDevice::delete_all_keys() {
    ...
    return hkm_client_->host_keymaster_send(KM_DELETE_ALL_KEYS, request, &response);
}

hw_device_t* HostKeymasterDevice::hw_device() {
    return &device_.common;
}

static inline HostKeymasterDevice* convert_device(const keymaster2_device_t* dev) {
    return reinterpret_cast<HostKeymasterDevice*>(const_cast<keymaster2_device_t*>(dev));
}

/* static */
int HostKeymasterDevice::close_device(hw_device_t* dev) {
    delete reinterpret_cast<HostKeymasterDevice*>(dev);
    return 0;
}

/* static */
keymaster_error_t HostKeymasterDevice::configure(const keymaster2_device_t* dev,
                                                   const keymaster_key_param_set_t* params) {
    return convert_device(dev)->configure(params);
}

/* static */
keymaster_error_t HostKeymasterDevice::add_rng_entropy(const keymaster2_device_t* dev,
...
/* static */
keymaster_error_t HostKeymasterDevice::export_key(const keymaster2_device_t* dev,
...
/* static */
keymaster_error_t HostKeymasterDevice::attest_key(const keymaster2_device_t* dev,
...
/* static */
keymaster_error_t HostKeymasterDevice::begin(const keymaster2_device_t* dev,
...
/* static */
keymaster_error_t HostKeymasterDevice::update(
...
/* static */
keymaster_error_t HostKeymasterDevice::finish(const keymaster2_device_t* dev,
                                                keymaster_operation_handle_t operation_handle,
                                                const keymaster_key_param_set_t* in_params,
                                                const keymaster_blob_t* input,
                                                const keymaster_blob_t* signature,
...
/* static */
keymaster_error_t HostKeymasterDevice::abort(const keymaster2_device_t* dev,
                                               keymaster_operation_handle_t operation_handle) {
    return convert_device(dev)->abort(operation_handle);
}

/* static */
keymaster_error_t HostKeymasterDevice::delete_key(const keymaster2_device_t* dev,
                                               const keymaster_key_blob_t* key) {
   return convert_device(dev)->delete_key(key);
}

/* static */
keymaster_error_t HostKeymasterDevice::delete_all_keys(const keymaster2_device_t* dev) {
