...
#ifndef HOST_KEYMASTER_DEVICE_H_
#define HOST_KEYMASTER_DEVICE_H_
...
class HostKeymasterDevice {
  public:
     ...
     */
    __attribute__((visibility("default"))) explicit HostKeymasterDevice(
            const hw_module_t* module, HostKeymasterClient* hkm_client);
  ...
  private:
	...
	HostKeymasterClient* hkm_client_;
};

}  // namespace keymaster

#endif  // HOST_KEYMASTER_DEVICE_H_
